    ...
    public function getResponse(string $input, array $context = []): ChatResponse
    {
        try {
            ...
            if (
                ...
                $context['logger']->error(
                    'XaiModel API error: No valid response',
            ...
            throw new ApiException(
                '[xAI] Invalid API response: No content in response',
                $httpCode,
            ...
            if (
                ...
                $context['logger']->error(
                    'XaiModel unexpected exception: ' . $e->getMessage(),
                    ['exception' => get_class($e)]
                );
            }
            throw new ApiException(
                '[xAI] Unexpected error: ' . $e->getMessage(),
                0,
                '',
                $e
            );
